...
export function MobilePortrait({ caption, portraitAlt }: MobilePortraitProps) {
  return (
    <figure className="mobile-portrait">
      ...
      <div className="mobile-portrait__frame">
        ...
        <img className="mobile-portrait__image" src="/nicolas-decressac-2026.jpg" alt={portraitAlt} />
      </div>
